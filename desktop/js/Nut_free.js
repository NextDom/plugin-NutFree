...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'Model' || _cmd.logicalId == 'input_volt' || _cmd.logicalId == 'input_freq'|| _cmd.logicalId == 'output_volt' || _cmd.logicalId == 'output_freq'||_cmd.logicalId == 'output_power'||_cmd.logicalId == 'batt_charge'||_cmd.logicalId == 'batt_runtime') {
		tr += '<span><input type="checkbox" class="cmdAttr" data-size="mini" data-l1key="isVisible" checked/> {{Afficher}}<br/></span>';
	}
	if (_cmd.logicalId == 'input_volt' ||_cmd.logicalId == 'input_freq'||_cmd.logicalId == 'output_volt' ||_cmd.logicalId == 'output_freq'||_cmd.logicalId == 'output_power'||_cmd.logicalId == 'batt_charge'||_cmd.logicalId == 'batt_runtime') {
